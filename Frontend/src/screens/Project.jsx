...
//             <div className="ml-auto max-w-56 message flex flex-col p-2 bg-slate-400 w-fit rounded-md">
...
//               className='p-2 bg-slate-50 px-4 border-none flex-grow outline-none'
//               type="text"
...
//         <div
//           className={`sidePanel w-96 h-full flex flex-col gap-2 bg-slate-50 absolute transition-all ${isSidePanelOpen
//             ? 'translate-x-0'
//             : '-translate-x-full'
//             } top-0`}
//         >
        ...
        <div className="conversation-area pt-14 pb-10 flex-grow flex flex-col h-full relative">
          ...
          <div className="inputField w-full flex absolute bottom-0">
            <input
              value={message}
              onChange={(e) => setMessage(e.target.value)}
              className='p-2 px-4 bg-white/90 border-none outline-none flex-grow' type="text" placeholder='Enter message' />
            <button
              onClick={send}
