...
*/
declare function parser(source: string, options?: ParserInputOptions | null): MarkdownToJSX.ASTNode[];
/**
...
*/
type MarkdownCompilerOptions = Omit<MarkdownToJSX.Options, "createElement" | "wrapper" | "wrapperProps" | "forceWrapper" | "renderRule"> & {
	/**
